...
{{< notice warning >}}
At the moment of writing, **Docker VMM**, does not support **Rosetta 2** to run **x86_64** binaries on **Apple Silicon**, this is a limitation imposed by Apple to custom **hypervisors** different from the **Virtualization.framework**, I don't know if this will change in the future, from what they said, they are working on it.
{{< /notice >}}
